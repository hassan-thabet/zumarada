      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              title:
                  Text('My Address', style: Theme.of(context).textTheme.button),
            ...
            ListTile(
              title: Text('Account', style: Theme.of(context).textTheme.button),
            ...
            ListTile(
              title: Text('Devices', style: Theme.of(context).textTheme.button),
